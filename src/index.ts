...
if (!API_KEY) {
  console.error("[clamp] CLAMP_API_KEY is required. Set it in your MCP config env.");
  process.exit(1);
}
...
async function bootstrap(): Promise<void> {
  ...
  if (!res.ok) {
    ...
    console.error(`[clamp] Bootstrap failed (${res.status}): ${body}`);
    process.exit(1);
  }
...
server.tool(
  ...
  async ({ period, pathname, utm_source, utm_campaign }) => {
    const data = await api(
      `/analytics/${PROJECT_ID}/overview${qs({ period, pathname, utm_source, utm_campaign })}`,
    );
...
server.tool(
  ...
  async ({ period, limit }) => {
    const data = await api(
      `/analytics/${PROJECT_ID}/top-pages${qs({ period, limit })}`,
    );
    return { content: [{ type: "text", text: JSON.stringify(data, null, 2) }] };
  },
);
...
server.tool(
  ...
  async ({ period, limit, channel, pathname }) => {
    const data = await api(
      `/analytics/${PROJECT_ID}/top-referrers${qs({ period, limit, channel, pathname })}`,
    );
    return { content: [{ type: "text", text: JSON.stringify(data, null, 2) }] };
  },
);
...
server.tool(
  ...
  async ({ period, limit }) => {
    const data = await api(
      `/analytics/${PROJECT_ID}/countries${qs({ period, limit })}`,
    );
    return { content: [{ type: "text", text: JSON.stringify(data, null, 2) }] };
  },
);
...
server.tool(
  ...
  async ({ period, limit, country }) => {
    const data = await api(
      `/analytics/${PROJECT_ID}/cities${qs({ period, limit, country })}`,
    );
    return { content: [{ type: "text", text: JSON.stringify(data, null, 2) }] };
  },
);
...
server.tool(
  ...
  async ({ period, limit, group_by }) => {
    const data = await api(
      `/analytics/${PROJECT_ID}/devices${qs({ period, limit, group_by })}`,
    );
    return { content: [{ type: "text", text: JSON.stringify(data, null, 2) }] };
  },
);
...
server.tool(
  ...
  async ({ period, limit, name, property, value, group_by, utm_source, utm_campaign }) => {
    const data = await api(
      `/analytics/${PROJECT_ID}/events${qs({ period, limit, name, property, value, group_by, utm_source, utm_campaign })}`,
    );
    return { content: [{ type: "text", text: JSON.stringify(data, null, 2) }] };
  },
);
...
server.tool(
  ...
  async ({ period, event, granularity, property, value }) => {
    const data = await api(
      `/analytics/${PROJECT_ID}/timeseries${qs({ period, event, granularity, property, value })}`,
    );
    return { content: [{ type: "text", text: JSON.stringify(data, null, 2) }] };
  },
);
...
server.tool(
  ...
  async ({ name, steps }) => {
    const data = await api(`/analytics/${PROJECT_ID}/funnels`, {
      method: "POST",
...
server.tool(
  ...
  async ({ name, period, country, channel, device_type, utm_source, utm_campaign, pathname }) => {
    const data = await api(
      `/analytics/${PROJECT_ID}/funnels${qs({ name, period, country, channel, device_type, utm_source, utm_campaign, pathname })}`,
    );
    return { content: [{ type: "text", text: JSON.stringify(data, null, 2) }] };
  },
);
...
server.tool(
  ...
  async ({ metric, condition, threshold, period, pathname }) => {
    const data = await api(`/analytics/${PROJECT_ID}/alerts`, {
      method: "POST",
