...
export function registerClampTools(server: McpServer, ctx: ClampToolContext): void {
  ...
  server.tool(
    ...
    async ({ period, pathname, utm_source, utm_campaign, referrer_host }) => {
      const data = await api(
        subst(`/analytics/{pid}/overview${qs({ period, pathname, utm_source, utm_campaign, referrer_host })}`),
      );
      return json(data);
    },
  );
  ...
  server.tool(
    ...
    { period: periodParam, limit: limitParam, referrer_host: referrerHostParam },
    async ({ period, limit, referrer_host }) => {
      const data = await api(subst(`/analytics/{pid}/top-pages${qs({ period, limit, referrer_host })}`));
      return json(data);
    },
  );
  ...
  server.tool(
    ...
    { period: periodParam, limit: limitParam, channel: channelParam, pathname: pathnameParam },
    async ({ period, limit, channel, pathname }) => {
      const data = await api(
        subst(`/analytics/{pid}/top-referrers${qs({ period, limit, channel, pathname })}`),
      );
      return json(data);
    },
  );
  ...
  server.tool(
    ...
    { period: periodParam, limit: limitParam },
    async ({ period, limit }) => {
      const data = await api(subst(`/analytics/{pid}/countries${qs({ period, limit })}`));
      return json(data);
    },
  );
  ...
  server.tool(
    ...
    async ({ period, limit, country }) => {
      const data = await api(subst(`/analytics/{pid}/cities${qs({ period, limit, country })}`));
      return json(data);
    },
  );
  ...
  server.tool(
    ...
    async ({ period, limit, group_by }) => {
      const data = await api(subst(`/analytics/{pid}/devices${qs({ period, limit, group_by })}`));
      return json(data);
    },
  );
  ...
  server.tool(
    ...
    async ({ period, event, granularity, property, value, referrer_host }) => {
      const data = await api(
        subst(`/analytics/{pid}/timeseries${qs({ period, event, granularity, property, value, referrer_host })}`),
      );
      return json(data);
    },
  );
